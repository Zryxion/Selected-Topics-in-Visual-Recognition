...
class PromptIRModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.outputs.append((restored.detach(), clean_patch.detach()))  # Save for PSNR
        
        self.log("train_loss", loss, prog_bar=True)
        return loss

    def on_train_epoch_end(self):
        # Compute average PSNR for the epoch
        total_psnr = 0.0
        count = 0
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(dirpath = opt.ckpt_dir,every_n_epochs = 2,save_top_k=-1)
